...
export default function Dashboard() {
  ...
  const isDataIncomplete =
    !dashboardState ||
    ((!Array.isArray(dashboardState.debts) ||
      dashboardState.debts.length === 0) &&
      (!Array.isArray(dashboardState.bankConnections) ||
        dashboardState.bankConnections.length === 0));
  ...
  // If not mounted yet (during SSR), show a basic loading state
  if (!mounted) {
    return (
      <div className="container max-w-7xl mx-auto py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          <div className="h-64 w-full rounded-xl bg-gray-900/50 border border-white/10 animate-pulse" />
          <div className="h-64 w-full rounded-xl bg-gray-900/50 border border-white/10 animate-pulse" />
        </div>
      </div>
    );
    ...
    return (
      <div className="container max-w-7xl mx-auto py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Skeleton className="h-80 w-full rounded-xl" variant="card" />
          <Skeleton className="h-80 w-full rounded-xl" variant="card" />
        </div>
      </div>
    );
    ...
    return (
      <div className="container max-w-7xl mx-auto py-8">
        ...
        <p className="text-white/70 mb-8">
          Connect your bank accounts to get started with personalized insights.
        </p>

        <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/40 border border-white/10 backdrop-blur-sm p-8 rounded-xl mb-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-white/70 mb-6">
              To provide you with personalized insights and debt management
              strategies, we need to connect to your financial accounts.
            </p>
            ...
            <div className="grid gap-6 mb-8">
              <div className="flex items-start">
                ...
                <div className="text-left">
                  ...
                  <p className="text-white/70 text-sm">
                    Connect your bank accounts to automatically import and
                    organize all your outstanding debts.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="text-left">
                  ...
                  <p className="text-white/70 text-sm">
                    Our AI analyzes your financial data to create optimized debt
                    payoff strategies tailored just for you.
                  </p>
                </div>
              </div>
            </div>
  ...
  const averageInterestRate = dashboardState?.debtBreakdown?.length
    ? (
        dashboardState.debtBreakdown.reduce(
          ...
          0
        ) / dashboardState.debtBreakdown.length
      ).toFixed(1) + "%"
    : "N/A";
  ...
  const debtFreeDateFormatted = debtFreeDate.toLocaleDateString("en-US", {
    year: "numeric",
    month: "long",
  });
  ...
  return (
    <div className="container max-w-7xl mx-auto py-8 px-4 sm:px-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold mb-1 bg-gradient-to-r from-[#88B04B] to-[#6A9A2D] bg-clip-text text-transparent">
            Your Dashboard
          </h1>
                    ...
                    <>
                      ...
                      <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <MetricCard
                          ...
                          icon={
                            <CreditCard className="w-4 h-4 text-[#88B04B]" />
                          }
                          trend={
                          ...
                          change={
                            formatCurrency(
                              Math.abs(dashboardState.monthlyChange || 0)
                            ) + "/mo"
                          }
                        ...
                        <MetricCard
                          ...
                          value={formatCurrency(
                            dashboardState.monthlyPayment || 0
                          )}
                        ...
                        <MetricCard
                          ...
                          icon={
                            <TrendingUp className="w-4 h-4 text-[#88B04B]" />
                          }
                          ...
                          <div className="bg-black/20 rounded-lg p-4 border border-white/10">
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-white/70 text-sm">
                                  Based on your current payments, you'll be
                                  debt-free by{" "}
                          ...
                          <div className="bg-black/20 rounded-lg p-4 border border-white/10">
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-white/70 text-sm">
                                  You've made{" "}
                                  <span className="text-white">12</span> on-time
                                  payments in a row. Great job!
                                </p>
                              </div>
                            </div>
                          </div>
        ...
        <AlertDialogContent className="bg-gray-900 border border-white/10 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-white/70">
              {refreshError ||
                "There was an issue refreshing your dashboard data. Please try again later."}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel className="bg-white/5 border border-white/20 text-white hover:bg-white/10">
              Close
            </AlertDialogCancel>
            <AlertDialogAction
              onClick={handleRefreshDashboard}
          ...
          <div className="relative z-10">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-white/70 text-center">
                Link your bank accounts to automatically import your debts and
