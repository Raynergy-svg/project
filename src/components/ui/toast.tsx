  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "default" && "bg-[#1E1E1E] text-white",
        variant === "destructive" &&
